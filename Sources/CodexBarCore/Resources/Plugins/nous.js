...
defineProvider({
  ...
  async fetchUsage(ctx) {
    ...
    const remaining = _nullishCoalesce(number(subscription.credits_remaining, "credits_remaining"), () =>
    ...
    const purchased = _nullishCoalesce(number(root.purchased_credits_remaining, "purchased_credits_remaining"), () =>
    ...
    return {
      ...
      identity: {
        ...
        loginMethod: _nullishCoalesce(text(subscription.plan), () =>
          access.has_active_subscription === true ? "Subscription" : undefined,
        ),
      },
